 ...
 *
 * @param object $report
 * @param string|null $filepath Absolute path, or null to send to browser.
 * @param string|null $downloadfilename Filename for browser download.
 * @return void
 */
