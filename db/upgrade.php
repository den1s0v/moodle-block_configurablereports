...
function xmldb_block_configurable_reports_upgrade($oldversion) {
    ...
    if ($oldversion < 2027061418) {
        upgrade_plugin_savepoint(true, 2027061418, 'block', 'configurable_reports');
    }

    if ($oldversion < 2027061419) {
        upgrade_plugin_savepoint(true, 2027061419, 'block', 'configurable_reports');
    }
