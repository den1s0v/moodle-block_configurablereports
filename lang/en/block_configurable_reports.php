...
$string['reportchain_summary'] = 'Child report: {$a}';
$string['reportchain_summary_named'] = '{$a->chain} → {$a->child}';
$string['chainexportlistlabel'] = '{$a->chain} (child: {$a->child})';
$string['chainexportviewreport'] = 'View parent report';
$string['chainerror_noname'] = 'Enter a chain name.';
$string['reportchain_summary_empty'] = 'Child report not selected';
$string['reportchain_summary_missing'] = 'Child report missing';
$string['chainenabled'] = 'Enable chain export';
$string['chainchildreport'] = 'Child report';
...
$string['chainrowkeycolumns_help'] = 'Comma-separated parent report column names used to identify rows and build filenames.';
$string['chainsourcecolumn'] = 'Parent column';
$string['chaintargetfilter'] = 'Child filter parameter';
...
$string['chainnofilters'] = 'The selected child report has no filters configured.';
$string['chainexport'] = 'Chain export';
$string['chainexportlink'] = 'Bulk chain export...';
$string['chainexportheadingcontext'] = 'Chain export: {$a->parent} → {$a->chain}';
$string['chains_usage_help'] = 'Chains let you parameterise another report using the results of this report. To use a chain, go to {$a->viewreportlink}, configure the desired rows with filters, then click "{$a->exportlink}".';
$string['chainexportchoose'] = 'Choose a configured chain to export child reports for selected parent rows.';
$string['chainexportintro'] = 'Select rows from the parent report and download one child report file per row.';
...
$string['chainmaxrowsinfo'] = 'Maximum number of parent rows that can be exported in one chain download.';
