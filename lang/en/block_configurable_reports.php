...
$string['reportchain_summary'] = 'Target report: {$a}';
...
$string['chainrowkeycolumns_help'] = 'Comma-separated source report column names used to identify rows and build filenames.';
