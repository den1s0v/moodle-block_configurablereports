...
$string['reportchain_summary'] = 'Целевой отчёт: {$a}';
...
$string['chainexportheadingcontext'] = 'Экспорт по цепочке: {$a->parent} → {$a->chain}';
...
$string['chainexportchoose'] = 'Выберите настроенную цепочку для экспорта целевых отчётов по строкам родителя.';
$string['chainexportintro'] = 'Выберите строки родительского отчёта и скачайте отдельный файл целевого отчёта для каждой строки.';
