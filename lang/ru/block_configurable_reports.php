...
$string['chainfilterbindingsheader'] = 'Фильтры целевого отчёта (настройка каждого фильтра)';
$string['chainfilterbindingsheader_help'] = 'Для каждого фильтра целевого отчёта укажите, как задаётся значение при экспорте цепочки: из колонки источника, явно пустое или фиксированная константа для всех строк. Строки с одинаковыми column-привязками объединяются в один файл экспорта.';
$string['chainfilterbindingheader'] = 'Фильтр {$a}';
$string['chainfiltermode_column'] = 'Из колонки источника';
$string['chainfiltermode_empty'] = 'Пусто';
$string['chainfiltermode_constant'] = 'Константа';
$string['chainaddmapping'] = 'Добавить сопоставление';
$string['chainremovemapping'] = 'Удалить сопоставление';
$string['chainselectchildhint'] = 'Выберите целевой отчёт и нажмите «Продолжить».';
$string['chaincontinueconfig'] = 'Продолжить';
...
$string['chainexportmergedrows'] = '(объединено {$a} строк с одинаковым сопоставлением колонок)';
...
$string['chainzipfilenamepattern'] = 'Шаблон имени ZIP-архива';
$string['chainzipfilenamepattern_help'] = 'Плейсхолдеры: ##sourcereport##, ##targetreport##, ##chainname##. Пусто — {исходный}-{целевой}.zip';
$string['chainhelp_title'] = 'Как пользоваться экспортом по цепочке';
$string['chainhelp_link'] = 'Справка';
$string['chainhelp_intro'] = 'Экспорт по цепочке запускает целевой отчёт для каждой выбранной строки исходного отчёта и упаковывает файлы в ZIP.';
$string['chainhelp_step1'] = 'Настройте хотя бы одну цепочку на вкладке «Цепочки» исходного отчёта (целевой отчёт, ключевые столбцы, привязки фильтров).';
$string['chainhelp_step2'] = 'Откройте исходный отчёт, примените фильтры и нажмите «Массовый экспорт по цепочке…».';
$string['chainhelp_step3'] = 'Выберите цепочку, отметьте строки, укажите формат и запустите экспорт.';
$string['chainhelp_step4'] = 'Для больших экспортов прогресс отображается в фоне; можно уйти со страницы и вернуться через тот же экран или вкладку «Цепочки».';
$string['chainhelp_step5'] = 'По завершении скачайте ZIP. Если экспорт прерван (например, после перезапуска сервера), можно продолжить с последнего шага или скачать частичный результат.';
$string['chainhelp_note'] = 'Для одного исходного отчёта одновременно выполняется только один экспорт; остальные запросы ждут в очереди.';
$string['chainexportmode'] = 'Режим экспорта по цепочке';
$string['chainexportmode_help'] = 'Синхронный экспорт выполняется в HTTP-запросе (для небольших объёмов). Асинхронный — в фоне с отслеживанием прогресса.';
$string['chainexportmode_inherit'] = 'Наследовать настройку сайта ({$a->current})';
$string['chainexportmode_sync'] = 'Синхронный';
$string['chainexportmode_async'] = 'Асинхронный (фоновый)';
$string['chainexportmode_default'] = 'Режим экспорта по цепочке по умолчанию';
$string['chainexportmode_default_help'] = 'Используется, когда отчёт наследует настройку сайта.';
$string['chainexportdelaythresholdms'] = 'Порог задержки между дочерними отчётами (мс)';
$string['chainexportdelaythresholdms_help'] = 'Пауза между запусками включается только если предыдущий дочерний отчёт выполнялся не меньше этого времени.';
$string['chainexportdelaypercent'] = 'Процент задержки между дочерними отчётами';
$string['chainexportdelaypercent_help'] = 'При превышении порога — пауза в процентах от длительности последнего дочернего отчёта.';
$string['chainexportjobttl'] = 'Срок хранения архива экспорта (часы)';
$string['chainexportjobttl_help'] = 'Сколько часов готовый архив доступен для скачивания.';
$string['chainexportprogressheading'] = 'Прогресс экспорта';
$string['chainexportprogresslabel'] = 'Выполнено {$a->done} из {$a->total}';
$string['chainexportqueuewait'] = 'Ожидание в очереди (позиция {$a->position}). Выполняется другой экспорт этого отчёта. Ориентировочное ожидание: {$a->eta}.';
$string['chainexportcancelrequest'] = 'Отменить текущий запрос';
$string['chainexportcancelconfirm'] = 'Отменить этот запрос на экспорт?';
$string['chainexportcancelhint'] = 'Ваш запрос не будет поставлен в очередь и не будет выполнен.';
$string['chainexportdismiss'] = 'Сбросить запись об экспорте';
$string['chainexportdismissconfirm'] = 'Удалить эту запись из списка и разрешить новый экспорт?';
$string['chainexportdismissed'] = 'Запись об экспорте сброшена. Можно запустить новый экспорт.';
$string['chainexportnodownload'] = 'Архив недоступен для скачивания. При необходимости сбросьте запись и запустите экспорт заново.';
$string['chainexportstale'] = 'Экспорт перестал отвечать и помечен как ошибочный.';
$string['chainexportstalerunminutes'] = 'Таймаут зависшего экспорта (минуты)';
$string['chainexportstalerunminutes_help'] = 'Если выполняющийся экспорт не обновляется дольше этого времени, он помечается как ошибочный, чтобы очередь могла продолжиться.';
$string['chainexportnewexport'] = 'Новый экспорт';
$string['chainexportjobsheading'] = 'Мои экспорты по цепочкам для этого отчёта';
$string['chainexportjobchain'] = 'Цепочка';
$string['chainexportjobstatus'] = 'Статус';
$string['chainexportjobprogress'] = 'Прогресс';
$string['chainexportjobcreated'] = 'Создан';
$string['chainexportjobfinished'] = 'Завершён';
$string['chainexportjobmonitor'] = 'Мониторинг';
$string['chainexportstatus_queued'] = 'В очереди';
$string['chainexportstatus_running'] = 'Выполняется';
$string['chainexportstatus_completed'] = 'Завершён';
$string['chainexportstatus_partial'] = 'Частичный';
...
$string['chainexportdeleteconfirm'] = 'Безвозвратно удалить эту запись об экспорте и связанные файлы?';
$string['chainexportdeleted'] = 'Запись об экспорте удалена.';
$string['chainexportclearall'] = 'Очистить все';
$string['chainexportclearallconfirm'] = 'Удалить все записи об экспортах для этого отчёта (кроме выполняющихся)?';
$string['chainexportdeletedall'] = 'Удалено записей: {$a}.';
$string['chainexportclearallskippedrunning'] = 'Ничего не удалено: {$a} экспорт(ов) ещё выполняются.';
$string['chainexportclearallnothing'] = 'Нечего удалять.';
$string['chainexportjobactions'] = 'Действия';
$string['chainexportstatcounts'] = 'Экспортировано: {$a->exported}, пропущено: {$a->skipped}';
$string['chainexportredownloadzip'] = 'Скачать снова';
$string['chainexportredownloadminutes'] = 'Период повторного скачивания (минуты)';
$string['chainexportredownloadminutes_help'] = 'После первого скачивания пользователь может скачать тот же архив повторно в течение этого периода (в минутах). По истечении срока файл удаляется с диска. Допустимо значение от 1; если пусто — используется 15.';
$string['chainexportjobgone'] = 'Эта запись об экспорте больше недоступна.';
$string['chainerror_jobnotdeletable'] = 'Нельзя удалить экспорт, пока он выполняется.';
$string['chainexportnoprogressminutes'] = 'Таймаут прерывания без прогресса (минуты)';
$string['chainexportnoprogressminutes_help'] = 'Если выполняющийся экспорт не обновляет прогресс дольше этого времени, он помечается как прерванный — пользователь может продолжить или скачать частичный результат.';
$string['chainerror_jobnotfound'] = 'Задача экспорта не найдена.';
$string['chainerror_jobnotready'] = 'Архив экспорта ещё не готов.';
...
$string['chainsettingsheading'] = 'Цепочки отчётов';
$string['chainsettingsheading_desc'] = 'Настройки цепочек и массового экспорта по цепочке (фоновые задачи, паузы между запусками, срок хранения архивов).';
...
$string['chainerror_missingfilterbinding'] = 'Не настроена привязка фильтра: {$a}';
$string['chainerror_nocolumnsource'] = 'Выберите колонку источника для фильтра: {$a}';
$string['chainerror_noconstantvalue'] = 'Укажите константу для фильтра: {$a}';
$string['chainerror_invalidfiltermode'] = 'Некорректный режим привязки для фильтра: {$a}';
$string['chainerror_unknowncolumn'] = 'Неизвестная колонка отчёта-источника: {$a}. Пересохраните SQL или обновите настройки цепочки.';
$string['chainerror_unknownfilter'] = 'Неизвестный фильтр целевого отчёта: {$a}. Обновите сопоставления для выбранного целевого отчёта.';
