...
$string['chainresavesqlforcolumns'] = 'Список колонок не зафиксирован. Сохраните SQL-запрос на вкладке «SQL» ещё раз — при сохранении должна вернуться хотя бы одна строка.';
