...
$string['filterdefault_intro'] = 'Заготовка для страницы отчёта: при первом открытии, пока фильтр не отправляли. После «Применить» с очищенным полем не подставляется.';
