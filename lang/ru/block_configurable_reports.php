...
$string['chainexportredownloadminutes_help'] = 'После первого скачивания пользователь может скачать тот же архив повторно в течение этого периода (5–60 минут). По истечении срока файл удаляется с диска.';
