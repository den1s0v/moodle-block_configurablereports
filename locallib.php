...
/** Neutralize filter placeholders for output column metadata extraction. */
defined('BLOCK_CONFIGURABLE_REPORTS_FILTER_EXEC_COLUMN_METADATA') || define('BLOCK_CONFIGURABLE_REPORTS_FILTER_EXEC_COLUMN_METADATA', 3);
